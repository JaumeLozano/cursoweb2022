 ...
 */
	...
	require 'index.view_examen.php';
	
	if ($enviado == 'true'){
		try {
			//Estableces una conexión a la Base de datos
			$conexion = new PDO('mysql:host=localhost;dbname=examen_db', 'root', '');
			//Revisas si se ha conectado
			echo "Todo OK conectado </br>" ;
			//Insertar datos del formulario
			$statement = $conexion->prepare('INSERT INTO alumnes_examen VALUES (null, :nombre, :correo)');
